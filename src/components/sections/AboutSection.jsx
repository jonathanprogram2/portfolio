    ...
    return (
        <section 
            className="
                ...
                max-[900px]:items-start max-[900px]:pt-31 max-[900px]:pb-24 about-section">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center max-w-7xl gap-12">
                ...
                >
                    <img
                        ...
                        className="w-full h-[70vh] object-cover grayscale group-hover:grayscale-0 transition-all duration-700 ease-in-out about-photo"
                    />
                </motion.div>
